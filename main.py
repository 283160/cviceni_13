...
print(ekg.count_above(1.0))

signal = RespirationSignal("EKG pacienta 42", [0.5, 1.2, 1.8, 0.9], 12)

print(f"Dechová frekvence: {signal.breathing_rate}")